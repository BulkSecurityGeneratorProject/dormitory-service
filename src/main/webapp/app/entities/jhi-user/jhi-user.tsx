...
import { getEntities } from './jhi-user.reducer';
...
export class JhiUser extends React.Component<IJhiUserProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { jhiUserList, match } = this.props;
    return (
      <div>
        <h2 id="jhi-user-heading">
          <Translate contentKey="dormitoryServiceApp.jhiUser.home.title">Jhi Users</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="dormitoryServiceApp.jhiUser.home.createLabel">Create new Jhi User</Translate>
          </Link>
        </h2>
