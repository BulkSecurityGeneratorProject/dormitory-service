  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="dormitoryServiceApp.request.detail.title">Request</Translate> [<b>{requestEntity.id}</b>]
          </h2>
