  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dormitoryServiceApp.request.delete.question">
          <Translate contentKey="dormitoryServiceApp.request.delete.question" interpolate={{ id: requestEntity.id }}>
